  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Welcome to Farmfing! You can now log in to your account.",
      });
    }, 1500);
  };
  ...
  return (
    <Card className="w-full max-w-md mx-auto">
      <CardHeader className="space-y-1">
        ...
        <CardDescription>
          Enter your details to create your Farmfing account
        </CardDescription>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Label htmlFor="agreeTerms" className="text-sm font-normal cursor-pointer">
              I agree to the{" "}
              <Link to="/terms" className="text-farmfing-primary hover:underline">
                Terms of Service
              </Link>{" "}
              and{" "}
              <Link to="/privacy" className="text-farmfing-primary hover:underline">
                Privacy Policy
              </Link>
            </Label>
          </div>
      ...
      <CardFooter className="flex flex-col space-y-4">
        ...
        <div className="text-center text-sm">
          ...
          <Link to="/login" className="text-farmfing-primary hover:underline font-medium">
            Login
          </Link>
        </div>
      </CardFooter>
