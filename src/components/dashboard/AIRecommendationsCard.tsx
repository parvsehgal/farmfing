...
const recommendations = [
  {
    ...
    description:
      "Current stock is low based on your usage patterns. Recommended order: 25kg.",
    action: "Place Order",
    urgent: true,
  },
  {
    ...
    description:
      "8 avocados are nearing ripeness and should be used soon to prevent waste.",
    action: "Mark Used",
    urgent: true,
  },
  {
    ...
    description:
      "Order 50kg of rice to receive a 15% discount from your supplier.",
    action: "View Deal",
    urgent: false,
  },
  {
    ...
    description:
      "Based on seasonal trends, increase protein orders by 20% for next month.",
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Smart insights to optimize your inventory
        </CardDescription>
      </CardHeader>
      <CardContent>
          ...
          {recommendations.map((recommendation) => (
            ...
            >
              <div className="flex justify-between">
                <span
                  className={`text-xs font-medium px-2 py-1 rounded ${recommendation.type === "Reorder"
                      ? "bg-blue-100 text-blue-800"
                      : recommendation.type === "Waste Reduction"
                        ? "bg-red-100 text-red-800"
                        : recommendation.type === "Cost Saving"
