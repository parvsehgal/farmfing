...
const HeroSection = () => {
  return (
    <div className="bg-gradient-to-br from-green-50 via-blue-50 to-amber-50 py-20 md:py-28">
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="lg:w-1/2 relative">
            <div className="relative z-10 flex rounded-2xl shadow-2xl overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent px-6 py-4">
                    <div className="flex justify-between items-center">
                      <div className="text-white space-y-1">
                        ...
                        <p className="text-xs md:text-sm text-gray-100 opacity-80">Quality Produce Network</p>
                      </div>
                      <div className="text-white text-right space-y-1">
                        ...
                        <p className="text-xs md:text-sm text-gray-100 opacity-80">Premium Ingredients Sourcing</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {/* Quality Badge */}
            <div className="absolute -bottom-12 left-1/2 -translate-x-1/2 w-[330px] sm:w-[340px] bg-white/95 border border-gray-200 shadow-xl p-5 rounded-xl flex flex-col items-center z-20 hidden lg:flex"
                 style={{
                   boxShadow:
                     "0 4px 24px 0 rgba(34,34,34,0.08), 0 1.5px 9px 0 rgba(34,34,34,0.12)",
                 }}>
