        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
          ...
          <div className="lg:w-1/2 space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-lg">
              <Link to="/signup?type=restaurant" className="w-full sm:w-auto">
                <Button
                  size="lg"
                  className="w-full bg-primary hover:bg-primary/90 text-white font-semibold rounded-full h-14"
                >
              ...
              <Link to="/signup?type=supplier" className="w-full sm:w-auto">
                <Button
                  variant="outline"
                  size="lg"
                  className="w-full border-2 border-primary hover:bg-primary/10 text-primary font-semibold rounded-full h-14"
                >
          ...
          <div className="lg:w-1/2 relative">
            <div className="relative z-10">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent px-6 py-4">
                    <div className="flex justify-between items-end">
                      <div className="text-white space-y-1">
                        ...
                        <p className="text-xs md:text-sm text-gray-100 opacity-90">
                          Quality Produce Network
                        </p>
                      </div>
              ...
              {/* Quality Badge */}
              <div
                className="absolute -bottom-12 left-1/2 -translate-x-1/2 w-[330px] bg-white border border-gray-200 shadow-xl p-5 rounded-xl flex flex-col items-center z-20 hidden lg:flex"
                style={{
                  boxShadow:
