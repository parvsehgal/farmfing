...
import { Activity, Package, Calendar, DollarSign, AlertTriangle } from 'lucide-react';
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
            <div>
              ...
              <p className="text-gray-600">Welcome back! Here's an overview of your restaurant supplies.</p>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    <p className="text-sm text-gray-500 mt-1">Expected within 3 days</p>
                  </CardContent>
                </Card>
                <Card>
                  <CardHeader className="pb-2">
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    <p className="text-sm text-red-500 mt-1">Reorder required</p>
                  </CardContent>
                </Card>
              </div>
                      ...
                      <div className="h-[300px]">
                        ...
                        >
                          <LineChart data={salesData}>
                            ...
                            <Line type="monotone" dataKey="total" name="Sales" stroke="#2e7d32" strokeWidth={2} />
                          </LineChart>
                        </ChartContainer>
                      </div>
                    </CardContent>
              ...
              <div className="grid grid-cols-1 gap-6 mb-8">
                <Card>
                  ...
                  <CardContent className="h-[400px] flex items-center justify-center">
                    <p className="text-gray-500">Financial data visualization coming soon</p>
                  </CardContent>
                </Card>
              </div>
            </TabsContent>
            ...
            <TabsContent value="scheduling" className="pt-4">
              <div className="grid grid-cols-1 gap-6 mb-8">
                <Card>
                  ...
                  <CardContent className="h-[400px] flex items-center justify-center">
                    <p className="text-gray-500">Scheduling calendar coming soon</p>
                  </CardContent>
                </Card>
              </div>
            </TabsContent>
