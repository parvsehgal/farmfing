            ...
            <div className="lg:w-2/3">
              <div className="bg-white rounded-lg shadow overflow-hidden">
                <div className="hidden md:flex border-b p-4">
                  ...
                  <div className="w-1/5 font-medium text-gray-600">Quantity</div>
                  <div className="w-1/5 font-medium text-gray-600">Total</div>
                </div>
                
                {items.map((item) => (
                  <div key={item.id} className="border-b p-4 flex flex-wrap md:flex-nowrap items-center">
                    {/* Item */}
                    ...
                    {/* Quantity */}
                    <div className="w-1/3 md:w-1/5 flex items-center md:justify-start mb-4 md:mb-0">
                      <span className="md:hidden font-medium text-gray-600 mr-2">Qty:</span>
